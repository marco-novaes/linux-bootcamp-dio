...
useradd maria -m -s /bin/bash -p $(oepnssl passwd -6 senha123) -G GRP_ADM
useradd joao -m -s /bin/bash -p $(opensssl passwd -6 senha123) -G GRP_ADM
...
useradd amanda -m -s /bin/bash -p $(oepenssl passwd -6 senha123) -G GRP_SEC
